...
done_processing:
  ...
  memif.read(0x80000000, mem_size, reinterpret_cast<void*>(top->rootp->ariane_testharness__DOT__i_sram__DOT__gen_cut__BRA__0__KET____DOT__i_tc_sram_wrapper__DOT__i_tc_sram__DOT__sram.data()));
#else
  // Verilator v4
